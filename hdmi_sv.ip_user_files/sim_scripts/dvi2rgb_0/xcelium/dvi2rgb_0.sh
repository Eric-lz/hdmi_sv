...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ericp/nexysvideo/hdmi_sv/hdmi_sv.cache/compile_simlib/xcelium"
  fi
