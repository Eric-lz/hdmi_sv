...
#
# Script generated by Vivado on Fri Feb 21 15:21:45 -03 2025
...
# script info
echo -e "dvi2rgb_0.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../hdmi_sv.gen/sources_1/ip/dvi2rgb_0/src/ila_refclk/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ericp/nexysvideo/hdmi_sv/hdmi_sv.cache/compile_simlib/vcs"
  fi
