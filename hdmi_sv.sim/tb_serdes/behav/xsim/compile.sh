...
#
# Generated by Vivado on Thu Apr 03 15:01:53 -03 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_serdes_vlog.prj"
xvlog --incr --relax -L uvm -prj tb_serdes_vlog.prj 2>&1 | tee compile.log
